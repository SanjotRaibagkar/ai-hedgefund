#!/usr/bin/env python3
"""
Fix migration from SQLite to DuckDB
"""
...
def fix_migration():
    """Properly migrate data from SQLite to DuckDB."""
    logger.info("🔧 Fixing migration from SQLite to DuckDB...")
    ...
    try:
        ...
        # Insert using pandas to_parquet method
