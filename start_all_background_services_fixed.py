#!/usr/bin/env python3
"""
Fixed Unified Background Services Manager
Manages all 3 background services using direct scripts to avoid encoding issues.
"""
...
class FixedBackgroundServiceManager:
    """Fixed manager for all background services."""
    
    def __init__(self):
        """Initialize the service manager."""
        self.services = {
            'options_analysis': {
                'script': 'junk/run_options_scheduler.py',
                'name': 'Options Analysis Scheduler',
                'process': None,
                'pid': None
            },
            'intraday_collection': {
                'script': 'src/intradayML/data_collector.py',
                'name': 'Intraday Data Collection',
                'process': None,
                'pid': None
            },
            'options_collection': {
                'script': 'run_options_collector_direct.py',
    ...
    def start_all_services(self):
        ...
        print("Starting Fixed Unified Background Services Manager")
        print("=" * 60)
    ...
    def print_status(self):
        ...
        print("\n" + "=" * 80)
        print("FIXED BACKGROUND SERVICES STATUS")
        print("=" * 80)
...
def main():
    """Main function."""
    print("Fixed Unified Background Services Manager")
    print("=" * 50)
    print("Managing: Options Analysis, Intraday Collection, Options Collection")
    print("=" * 50)
    
    manager = FixedBackgroundServiceManager()
